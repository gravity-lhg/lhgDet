...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = nn.Conv2d(inplanes, planes, kernel_size=1, bias=1)
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=100, if_include_top=False):
...
if __name__=='__main__':
    ...
    net = resnet50(if_include_top=True)
    inputs = torch.rand(3, 3, 224, 224).clone().detach()
    outputs = net(inputs)
    print(outputs.shape)
